...
public class SpecificationController {
	 ...
	 */
	@RequestMapping("/add")
	public InsertResult add(@RequestBody Specification specification){
		try {
	...
	public InsertResult update(@RequestBody Specification specification){
		try {
	 ...
	 * @return
	 */
	@RequestMapping("/selectTSFOptionList.do")
	public List<Map> selectTSFOptionList(){
		List<Map> maps = specificationService.selectTSFOptionList();
		return maps;
	}
}
