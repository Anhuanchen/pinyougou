...
app.controller('typeTemplateController' ,function($scope,$controller,typeTemplateService,brandService,specificationService){
	...
	$scope.findIndistinct=function(page,rows){
		typeTemplateService.findIndistinct(page,rows,$scope.IndistinctEntity).success(
			function(response){
				$scope.list=response.rows;	
    ...
    //规格下拉列表
    $scope.selectTSFOptionList=function () {
        specificationService.selectTSFOptionList().success(
            function (response) {
